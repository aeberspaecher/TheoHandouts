...
equation''\footnote{Ein Reim auf die bekannte Klein-Gordon-Gleichung, einer
relativistischen Schrödingergleichung (für Spin-0-Teilchen)}
\begin{equation}
...
\end{align*}
Wir leiten nun die Euler-Lagrange-Gleichung für das Feld $\psi^*$ ab. Es ist
\begin{align*}
\firstpderiv{\LD}{(\psi^*)} &= \frac{\ii\hbar}{2}\dot\psi-V(\vec r)\psi\,,\\
-\firstpderiv{}{t}\firstpderiv{\LD}{(\dot\psi^*)} &= \frac{\ii\hbar}{2}\dot\psi\,,\\
-\nabla\cdot\firstpderiv{\LD}{(\nabla\psi^*)} &= +\frac{\hbar^2}{2m}\nabla\cdot\nabla\psi = +\frac{\hbar^2}{2m}\Delta\psi\,.
\end{align*}
Die Summe dieser Terme ergibt mit der Euler-Lagrange-Gleichung \eqref
{eq:ELG} gerade
\begin{equation}
\ii\hbar \dot\psi =\left[ -\frac{\hbar^2}{2m}\Delta + V(\vec r)\right]\psi\,,
\end{equation}
die Schrödinger-Gleichung! Man beachte, dass damit nicht die komplette
Quantenmechanik abgeleitet ist -- diese besteht neben der
